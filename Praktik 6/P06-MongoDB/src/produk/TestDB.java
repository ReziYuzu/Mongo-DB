...
public class TestDB {
    public static void main(String[] args) {
        try {
            //koneksi kedatabase MongoDB
            MongoDatabase database =Koneksi.sambungDB();
            
            //Menlhat daftar koleksi (tabel);
            System.out.println("====================");
            System.out.println("Daftar Table dalam Databases");
            ...
            col.insertOne(doc);
            System.out.println("Data telah tersimpan dalam koleksi");
            
            //mendapatkan _id dari dokuen yang baru saja diinsert
